...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://root:letmein123@awseb-e-4pceiq2mcm-stack-awsebrdsdatabase-0hzwznhipfqu.cl2yr0yt9ms9.us-west-1.rds.amazonaws.com:5432/ebdb'
    db.init_app(app)
